...
/**
 * This assignment has you practice writing functions.  Test cases are
 * provided in code, so when you run the program, it will tell you if the
 * functions are working right.
 *
 * Instructions
 *
 * 1. Read all of the code all the way through.
 * 2. Figure out what should be in the _____ areas.  Fix them for all the methods, 
 * so the code will compile.
 * 3. Compile the code to check your work on data types and names.
 * 4. Figure out what code belongs in the // TODO areas.  Write that    
 * code, one function at a time.
 * 5. Compile and run frequently as you work, noting your progress
...
{
    /**
     * Takes two integer numbers as input and returns whichever number
     * is smaller.
     */
    ...
    /**
     * Returns true if the integer input is an odd number (1, 3, 5,
     * 7...) */
    ...
    /**
     * Returns true if the integer input is an even number (0, 2, 4,
     * 6, 8...) */
     ...
     *
     * Just use this as an example of how the methods will be called,
     * so
